...
describe("podarHistorico — o laço de lotes", () => {
  ...
  it("drena a prospecção com o padrão 365 e eleva o knob de 5 ao piso 90", async () => {
    ...
    // Pelo NOME, e não pela posição: a nona poda (0420) entrou depois dela.
  ...
  it("drena as observações do Jev com o padrão 90 e eleva o knob de 7 ao piso 30 (0420)", async () => {
...
describe("houveEfeito — as duas direções", () => {
  const base = {
    ...
    // Nona poda (migration 0420): as observações do Jev.
  ...
  it("...e apagou observação do Jev vencida → TAMBÉM audita (0420)", () => {
