 ...
 * repetiam `ghcr.io/423313` à mão em 31 lugares — fixtures E asserções.
...
const NAMESPACE_DESTE_REPO = "ghcr.io/423313";
 ...
 * `ghcr.io/423313`, e a URL do token parte o valor em
...
describe("o kit aponta para o que o CI realmente publica", () => {
  it("os defaults de código e os labels de origem apontam para este repositório", () => {
    const repo = "https://github.com/423313/DeskcommCRM";
