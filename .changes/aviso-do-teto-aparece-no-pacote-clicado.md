...
impacto: nada_mudou
secao: corrigido
titulo: Ao ligar um pacote de capacidades que não cabe, o aviso aparece no próprio pacote
---

Na configuração do agente, ligar um pacote que passaria do limite de capacidades era recusado
