...
secao: adicionado
titulo: Automação externa agora consegue abrir a primeira conversa com um cliente novo
---
Até aqui, uma automação de prospecção (por exemplo, um fluxo que acabou de captar um lead) não
