...
O saldo de uma conta e o saldo de pontos de um cliente **nunca são um número
guardado** — são sempre somados dos lançamentos. É o que garante que o relatório
...
**A comissão é decidida quando o item entra na comanda**, não quando ela fecha.
