...
-- voice_calls ganha `transcript = null` a mais.)
...
begin
  ...
  -- (0252) `transcript` entra na cascata junto com `peer_phone` — uma
  -- transcrição de ligação de voz é a pessoa falando, e pode conter o
  -- próprio nome dela. Deixar sobreviver ligada ao contact_id seria o mesmo
  -- buraco de reidentificação que a 0235 já fechou pro telefone.
