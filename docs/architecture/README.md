...
| `extensoes-declarativas.architecture.json` | marco 2: catálogo de ensaio, admissão, recibos, arquivo local, ativação por organização e guia no CRM; código nesta branch, E2E ainda pendente |
