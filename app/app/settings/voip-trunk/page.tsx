...
export default async function TrunkSettingsPage() {
  ...
  return (
    <div className="flex h-full flex-col gap-6 p-6">
      <header>
        <h1 className="text-2xl font-semibold tracking-tight">Trunk SIP</h1>
        <p className="text-sm text-muted-foreground">
          Credenciais de registro do seu provedor SIP (Asterisk/AudioSocket). Depois de salvar, aplique o
          bloco abaixo em <code>asterisk/pjsip.conf</code> na VPS — a aplicação ainda é manual.
        </p>
      </header>
