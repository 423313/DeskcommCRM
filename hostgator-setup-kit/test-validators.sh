...
# ── Sandbox de CHAVAS DE IA: o ambiente de quem roda é uma SEGUNDA fonte que o
...
# deixava o runner decidir o veredito. Medido em 24/09/2026: com
# AI_GATEWAY_API_KEY no ambiente, a suíte inteira reprova com EXATAMENTE o
# vermelho que o CI registrou no run 35948236372 — `✗ a tela final não avisa
...
# assertion daqui cobra o gateway. As outras três nomes contaminam ANTES:
