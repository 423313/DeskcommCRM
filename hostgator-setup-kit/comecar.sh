...
# Uso:
#   bash comecar.sh
#   curl -fsSL https://raw.githubusercontent.com/423313/DeskcommCRM/main/hostgator-setup-kit/comecar.sh | bash
#
set -euo pipefail

REPO_URL="${REPO_URL:-https://github.com/423313/DeskcommCRM.git}"
