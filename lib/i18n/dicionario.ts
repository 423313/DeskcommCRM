...
export const DICIONARIO: Traducoes = {
  ...
  "As automações “Quando um contato ganhar uma tag” disparam uma vez por contato: na primeira vez que ele vira cliente com a regra ligada. Não disparam para quem já era cliente ao ligar, nem de novo para quem cancela e marca outra vez.": { es: "Las automatizaciones “Cuando un contacto reciba una etiqueta” se activan una vez por contacto: la primera vez que pasa a ser cliente con la regla activada. No se activan para quien ya era cliente al activarla, ni de nuevo para quien cancela y vuelve a agendar." },
