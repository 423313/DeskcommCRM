...
export const DICIONARIO: Traducoes = {
  ...
  "Outra versão desta extensão já está instalada.": { es: "Ya hay otra versión de esta extensión instalada." },
  "Atualização de versão ainda não faz parte desta integração.": { es: "La actualización de versión aún no forma parte de esta integración." },
  ...
  "Esta versão do sistema ainda não atualiza extensões já instaladas.": { es: "Esta versión del sistema todavía no actualiza extensiones ya instaladas." },
  ...
  "Já existe uma preparação em andamento. Consulte o histórico para verificar ou cancelar o pedido.": { es: "Ya hay una preparación en curso. Consulta el historial para comprobar o cancelar la solicitud." },
  ...
  "O sistema está sendo atualizado. Aguarde a conclusão para instalar extensões.": { es: "El sistema se está actualizando. Espera a que termine para instalar extensiones." },
