...
export const DICIONARIO: Traducoes = {
  ...
  "A origem fica na mesma aba e no mesmo domínio durante a navegação. Uma nova campanha substitui a anterior. Ao clicar, o Deskcomm gera o código na mensagem; ele precisa ser enviado pelo visitante. A mensagem usada é a que você salvou na captura.": { es: "El origen se conserva en la misma pestaña y dominio durante la navegación. Una nueva campaña sustituye a la anterior. Al hacer clic, Deskcomm genera el código en el mensaje; el visitante debe enviarlo. Se usa el mensaje guardado en la captura." },
  "Para não guardar a origem na aba, adicione data-storage=\"none\" ao script. Para excluir um link, adicione data-deskcomm-ignore nele. Botões controlados apenas por JavaScript e links abreviados precisam de adaptação no site.": { es: "Para no guardar el origen en la pestaña, añada data-storage=\"none\" al script. Para excluir un enlace, añada data-deskcomm-ignore. Los botones controlados solo por JavaScript y los enlaces acortados necesitan adaptación en el sitio." },
