...
export const DICIONARIO: Traducoes = {
  ...
  "Há uma preparação desta extensão em andamento. Verifique ou cancele o pedido em Atividade recente antes de desfazer ou remover.": { es: "Hay una preparación de esta extensión en curso. Comprueba o cancela la solicitud en Actividad reciente antes de deshacer o quitar." },
