...
export const DICIONARIO: Traducoes = {
  ...
  "As automações “Quando um contato ganhar uma tag” disparam para quem virar cliente depois de ligar — não para quem já era cliente antes.": { es: "Las automatizaciones “Cuando un contacto reciba una etiqueta” se activan para quien pase a ser cliente después de activar esto — no para quien ya era cliente antes." },
  "Ligar clientes pela agenda?": { es: "¿Activar clientes por la agenda?" },
  "Todos os contatos que já tiveram horário marcado (sem contar cancelados e faltas) ganham a etiqueta “cliente” agora. Desligar depois não tira a etiqueta de ninguém.": { es: "Todos los contactos que ya tuvieron una cita (sin contar canceladas ni ausencias) reciben la etiqueta “cliente” ahora. Desactivarlo después no le quita la etiqueta a nadie." },
  ...
  "{m} deixaram de ser clientes: os horários deles foram cancelados ou tiveram falta enquanto a regra estava desligada.": { es: "{m} dejaron de ser clientes: sus citas se cancelaron o tuvieron ausencia mientras la regla estaba desactivada." },
