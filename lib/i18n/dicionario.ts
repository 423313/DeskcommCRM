...
export const DICIONARIO: Traducoes = {
  ...
  // ── fork: ficha da cliente, comissões e cartão de fidelidade ──────────────
  "{n} itens estão sem profissional e não vão gerar comissão. Depois de finalizar não dá para mudar.": { es: "{n} ítems están sin profesional y no van a generar comisión. Después de finalizar no se puede cambiar." },
  "1 item está sem profissional e não vai gerar comissão. Depois de finalizar não dá para mudar.": { es: "1 ítem está sin profesional y no va a generar comisión. Después de finalizar no se puede cambiar." },
  "A receber": { es: "Por cobrar" },
  "A regra mais específica vence: profissional e serviço vence profissional, que vence serviço. Não é o maior percentual que ganha.": { es: "Gana la regla más específica: profesional y servicio gana a profesional, que gana a servicio. No gana el porcentaje más alto." },
  "Adicionar profissional": { es: "Agregar profesional" },
  "Ainda não há comanda finalizada para esta cliente. Os indicadores aparecem depois do primeiro atendimento cobrado.": { es: "Todavía no hay comanda finalizada para esta clienta. Los indicadores aparecen después del primer servicio cobrado." },
  "Cartão completo — pode resgatar o prêmio na próxima comanda.": { es: "Tarjeta completa — puede canjear el premio en la próxima comanda." },
  "Cartão de fidelidade": { es: "Tarjeta de fidelidad" },
  ...
  "Em risco": { es: "En riesgo" },
  "Estornada": { es: "Anulada" },
  "Ex.: Scarlet": { es: "Ej.: Scarlet" },
  "faltam": { es: "faltan" },
  "Fechar e pagar": { es: "Cerrar y pagar" },
  "Histórico de comandas": { es: "Historial de comandas" },
  "Itens": { es: "Ítems" },
  "Mas já tem horário marcado.": { es: "Pero ya tiene hora agendada." },
  "Não foi possível carregar a ficha.": { es: "No fue posible cargar la ficha." },
  "Nenhum horário anterior.": { es: "Ningún horario anterior." },
  "Nenhum horário marcado.": { es: "Ningún horario agendado." },
  "Nenhuma comissão no período. Ela nasce quando uma comanda é finalizada com profissional no item e percentual configurado — cadastre as regras em Configurações › Financeiro.": { es: "Ninguna comisión en el período. Nace cuando una comanda se finaliza con profesional en el ítem y porcentaje configurado — registre las reglas en Configuración › Financiero." },
  "Nenhuma profissional cadastrada.": { es: "Ninguna profesional registrada." },
  "Nome da profissional": { es: "Nombre de la profesional" },
  "paga": { es: "pagada" },
  "Por profissional": { es: "Por profesional" },
  "Profissionais": { es: "Profesionales" },
  "Profissional": { es: "Profesional" },
  "Próximos horários": { es: "Próximos horarios" },
  "Qualquer profissional": { es: "Cualquier profesional" },
  "Quanto cada profissional recebe por atendimento. Sem regra, a comissão é zero.": { es: "Cuánto recibe cada profesional por servicio. Sin regla, la comisión es cero." },
  "Quanto cada profissional tem a receber no período, e o fechamento do pagamento.": { es: "Cuánto tiene por cobrar cada profesional en el período, y el cierre del pago." },
  "Quem executa o serviço. Não precisa de login: a profissional aparece na comanda e recebe comissão sem nunca abrir o sistema.": { es: "Quien ejecuta el servicio. No necesita acceso al sistema: la profesional aparece en la comanda y recibe comisión sin nunca abrirlo." },
  "selos": { es: "sellos" },
  "Sem comissão": { es: "Sin comisión" },
  "Sem compra": { es: "Sin compra" },
  "Serviços mais feitos": { es: "Servicios más realizados" },
  "Total gasto": { es: "Total gastado" },
  "Última visita": { es: "Última visita" },
  "Últimos horários": { es: "Últimos horarios" },
