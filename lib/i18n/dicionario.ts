...
export const DICIONARIO: Traducoes = {
  ...
  "A versão instalada continua a mesma. Confira o catálogo admitido e tente a atualização novamente.": { es: "La versión instalada sigue siendo la misma. Comprueba el catálogo admitido e intenta la actualización de nuevo." },
